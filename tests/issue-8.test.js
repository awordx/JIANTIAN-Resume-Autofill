...
test("release metadata must be stable and point to this repository", () => {
  const release = utils.normalizeRelease({
    tag_name: "v0.2.2",
    html_url: "https://github.com/awordx/JIANXING-Resume-Autofill/releases/tag/v0.2.2",
    body: "## 修复 PDF 解析\n\n其他内容",
    draft: false,
    prerelease: false
  });
  ...
  assert.deepEqual(release, {
    version: "v0.2.2",
    url: "https://github.com/awordx/JIANXING-Resume-Autofill/releases/tag/v0.2.2",
    summary: "修复 PDF 解析"
  });
  ...
  assert.equal(utils.normalizeRelease({
    ...
    html_url: "https://github.com/awordx/JIANXING-Resume-Autofill/releases/tag/v0.2.2-beta.1",
    prerelease: true
  }), null);
});
